          ...
          <div className="flex flex-col gap-4 lg:col-span-3">
            ...
            <div>
              <motion.div
                ...
                style={{ 
                  background: "linear-gradient(135deg, #D8CFBC 0%, #C8BFA8 50%, #B8AF94 100%)",
                ...
                <div className="grid grid-cols-2 gap-6">
                  {socialLinks?.map((social, index) => (
                    ...
                    >
                      <Link
                        href={social.url}
                        className="group relative flex items-center justify-center p-4 rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-lg"
                        style={{
                          textDecoration: "none",
                      ...
                      >
                        ...
                        <div className="relative flex flex-col items-center gap-2">
                          ...
                          {/* Nome da rede social */}
                          <span 
                            className="text-sm font-medium transition-colors duration-300 group-hover:text-opacity-90"
                            style={{ color: "#11120D" }}
                          >
                            {social.name}
                          </span>
